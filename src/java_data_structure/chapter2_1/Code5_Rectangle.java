...
// 평면상에 좌표축에 평행한 n개의 직사각형에 관한 데이터를 입력받은 후 면적이 작은 것부터 큰 것 순으로 정렬하여 출력
public class Code5_Rectangle {
    ...
    public static void main(String[] args) {
        try {
            Scanner in = new Scanner(new File("src\\\\java_data_structure\\\\chapter2_1\\\\data.txt"));
            while (in.hasNext()) {
